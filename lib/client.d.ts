...
declare const zh: {
  ...
  readonly 'confirm.delete': "确定从云端永久删除历史版本 %s 吗？该备份文件会被删除，不可恢复。";
  readonly 'phase.preparing': "准备";
  readonly 'phase.producing': "出包";
  readonly 'phase.uploading': "上传";
  readonly 'phase.finalizing': "收尾";
  readonly 'phase.downloading': "下载";
  readonly 'phase.restoring': "恢复";
  readonly 'phase.deleting': "删除";
  readonly 'phase.done': "完成";
  readonly 'progress.bytes': "已上传 %a / %b（%p%）";
