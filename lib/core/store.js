...
import { MANIFEST_SCHEMA_VERSION, emptyManifest, } from "./config.js";
/** manifest 在远端目录里的文件名。 */
export const MANIFEST_FILE = 'index.json';
/** 本地工作目录（下载下来的包、待上传的包都放这儿）。 */
export function localDir(dataDir) {
    return dataDir;
}
export function localTmpDir(dataDir) {
...
export function remoteFileName(at, hash) {
 ...
 */
export async function readRemoteManifest(transport, remoteDir) {
...
export async function writeRemoteManifest(transport, remoteDir, manifest) {
...
export function joinRemote(dir, file) {
...
export async function prepareLocalDir(dataDir) {
