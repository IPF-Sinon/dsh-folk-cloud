...
import { HostBackupProducer, HostBackupRestorer, appBridgeAvailable, configManagerAvailable, themeInfo, } from "./core/host-bridge.js";
import { deleteCommit, resolveConflict, restoreCommit, runSync } from "./core/sync-engine.js";
...
class CloudRuntime {
    ...
    emitLine(line) {
        ...
        if (this.run.lines.length > MAX_RUN_LINES)
            this.run.lines.splice(0, this.run.lines.length - MAX_RUN_LINES);
        this.log(line);
    }
